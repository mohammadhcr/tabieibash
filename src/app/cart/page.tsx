                        ...
                        <div className={cart} key={item.id}>
                            ...
                            <div className={info}>
                                ...
                                <h3 className={cartPrice}>
                                    {item.productprice.toLocaleString("fa-IR")}{" "}
                                    تومان <GoDotFill className={dot} />{" "}
                                ...
                                <div className={quantityControl}>
                                    <form action={plusQuantity}>
                                        ...
                                        <input
                                            ...
                                            type='hidden'
                                        />
                                        <SubmitButton classname='plusBtn'>
                                            <FaPlus />
                                        </SubmitButton>
                                    </form>
                                    {item.quantity === 1 ? (
                                        <form action={deleteItem}>
                                            <input
                                                ...
                                                type='hidden'
                                            />
                                            <SubmitButton classname='clearBtn'>
                                                <FaTrash />
                                            </SubmitButton>
                                        </form>
                                    ) : (
                                        <form action={minusQuantity}>
                                            ...
                                            <input
                                                ...
                                                type='hidden'
                                            />
                                            <SubmitButton classname='minusBtn'>
                                                <FaMinus />
                                            </SubmitButton>
                                        </form>
                                    )}
                    ...
                    <div className={checkout}>
                        <div className={BTNs}>
                            ...
                            <form action={clearCart}>
                                <SubmitButton classname='clearAll'>
                                    پاک کردن
                                </SubmitButton>
                            </form>
                        </div>
