...
const Podcast = async ({ params }: { params: Promise<{ slug: string }> }) => {
    ...
    const releasedate = releasedata.toLocaleString("fa-IR", {
        year: "numeric",
        month: "short",
        day: "numeric",
    });
                ...
                <div className={section}>
                    ...
                    <div className={listen}>
                        ...
                        <div className={links}>
                            ...
                            >
                                <FaSoundcloud className={platformIcon} />
                                ساندکلاد
                            </a>
                            <a
                                className={youtube}
                                ...
                                rel='noopener noreferrer'
                            >
                                <FaYoutube className={platformIcon} />
                                یوتیوب
                            </a>
                            <a
                                className={spotify}
                                ...
                                rel='noopener noreferrer'
                            >
                                <FaSpotify className={platformIcon} />
                                اسپاتیفای
                            </a>
                            <a
                                className={applePod}
                                ...
                                rel='noopener noreferrer'
                            >
                                <SiApplemusic className={platformIcon} />
                                اپل موزیک
                            </a>
                        </div>
                    </div>
