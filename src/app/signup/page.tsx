                    ...
                    <div className={title}>
                        ...
                        <div className={inputs}>
                            ...
                            <div className={input}>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value={emailAddress} onChange={e => setEmailAddress(e.target.value)} />
                                </div>
                            </div>
                            <div className={input}>
                                ...
                                <div>
                                    ...
                                    <input type={showPassword ? 'text' : 'password'} value={password} name="password" onChange={e => setPassword(e.target.value)} />
                                    <FaEye className={`${bxlp} ${showPassword ? `${bxlpActive}` : ''}`} onClick={() => setshowPassword(!showPassword)} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={submitB}>
                            <button onClick={submit} type="submit">
                                {btnLoad ? <span className={btnLoader}></span> : "ساخت حساب کاربری"}
                            </button>
                        </div>
                        <div className={line}>
                            <hr />
                        ...
                        <div className={socialLoginButtons}>
                            <button onClick={googleSignup} className={socialLoginButton}>
                                ...
                                {btnGoogle ? <span className={btnLoader}></span> : "ثبت نام با گوگل"}
                            </button>
                            <button onClick={gitHubSignup} className={socialLoginButton}>
                                <SiGithub className={bxl} />
                                {btnGitHub ? <span className={btnLoader}></span> : "ثبت نام با گیت‌هاب"}
                            </button>
                        </div>
                        <div className={options}>
                            <p>قبلا عضوی از ما شدی؟ <Link href="/login">وارد شو</Link></p>
                        </div>
                </div>
            : 
            <div className={signup}>
                <div className={title}>
                 ...
                 <div className={inputs}>
                     <div className={input}>
                         ...
                         <div>
                             <FaLock className={bxl} />
                             <input className={verifyCode} type="text" name="verify" value={code} onChange={e => setCode(e.target.value)} />
                         </div>
                     </div>
                 </div>
