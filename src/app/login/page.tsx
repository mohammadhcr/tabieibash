                    ...
                    <div className={title}>
                        ...
                        <div className={inputs}>
                            <div className={input}>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="email" value={identifier} onChange={e => setIdentifier(e.target.value)} />
                                </div>
                            </div>
                            <div className={input}>
                        ...
                        <div className={submitB}>
                            <button onClick={submit} type="submit">
                                {btnLoad ? <span className={btnLoader}></span> : "ورود به حساب کاربری"}
                            </button>
                        </div>
                        <div className={line}>
                            <hr />
                        ...
                        <div className={options}>
                            <p>عضوی از ما نیستی؟ <Link href="/signup">ثبت نام کن</Link></p>
                        </div>
                        <div className={options}>
                            <p>نیاز به کمک دارم! <Link href="/forgot-password">رمزم رو فراموش کردم</Link></p>
                        </div>
                </div>
        </form>
        </Suspense>
