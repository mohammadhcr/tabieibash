            ...
            <div className={mainContainer}>
                <div className={aboutUsTitle}>
                    ...
                    <p className={aSubTitle}>
                        یه شعار جذاب یک‌خطی که برند رو توصیف می‌کنه!
                    </p>
                </div>
                <div className={contactSection}>
                    <div className={contactLinks}>
                        <div>
                            <h2>پروفایل من در شبکه‌های اجتماعی</h2>
                        </div>
                        <div className={cLink}>
                            <a
                                href='mailto:mohammadhcr@icloud.com'
                                target='_blank'
                            ...
                            <a
                                ...
                                rel='noopener noreferrer'
                            >
                                <SiGithub className={cIcon} />
                                گیت‌هاب
                            </a>
                            <a
                                href='https://twitter.com/mohammadhcr'
                                target='_blank'
                                rel='noopener noreferrer'
                            >
                            ...
                            <a
                                href='https://t.me/mohammadhcr'
                                target='_blank'
                                rel='noopener noreferrer'
                            >
                                <FaTelegram className={cIcon} />
                                تلگرام
                            </a>
                            <a
